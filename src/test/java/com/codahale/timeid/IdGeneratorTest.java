...
class IdGeneratorTest {
  ...
  void generating() {
    ...
    assertThat(generator.generate()).isEqualTo("1KDSjUFWZq$$atrlGWkUGDtHlYc").hasSize(27);
    for (int i = 0; i < 100_000; i++) {
      generator.generate();
    }
    assertThat(generator.generate()).isEqualTo("1KDSjJNASxprjrrmQEPjv8vSvjw").hasSize(27);
  }
}
